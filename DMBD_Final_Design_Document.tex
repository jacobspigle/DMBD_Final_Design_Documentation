...
\section{d20 Terminology}
		...
		\begin{table}[H]
			\begin{center}
				\centering\begin{tabular}{ | >{\centering}m{2.5cm} | >{\centering}m{2.5cm} | >{\centering}m{2.5cm} | }
					\hline
					Lawful Good (LG) & Neutral Good (NG) & Chaotic Good (CG} \tabularnewline
					\hline
					Lawful Neutral (LN) & True Neutral (TN) & Chaotic Neutral (CN) \tabularnewline
					\hline
					Lawful Evil (LE) & Neutral Evil (NE) & Chaotic EvilC(CE) \tabularnewline
					\hline
				\end{tabular}
			\end{center}
		\caption{Alignment Table}
		\label{table: Alignment Table}
	\end{table}
		\newpage
