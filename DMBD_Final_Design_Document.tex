...
\addcontentsline{toc}{chapter}{Research}
	...
	\section{Game A.I.}
		...
		%ToDo: Reference image: https://en.wikipedia.org/wiki/Finite-state_machine
		...
		%ToDo: Reference image: https://en.wikipedia.org/wiki/Behavior_tree_(artificial_intelligence,_robotics_and_control)
...
This project will will deliver a web application for facilitating the creation, sharing, and testing of DnD 5e combat encounters. 
