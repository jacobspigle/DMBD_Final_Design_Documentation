...
Critical Encounters is a web-based platform designed to streamline the process for players of the d20 Game System to create and test encounters to bring forth to live games. Users will be able to publicly post their created encounters for others to play through and review as well.
...
\addcontentsline{toc}{chapter}{Research}
	...
	\section{Game A.I.}
		...
		\begin{figure}[H]
			...
			\caption{Standard MiniMax Tree \cite{minmax}}
			\label{fig: MiniMax}
		\end{figure}
