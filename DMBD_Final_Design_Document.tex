...
\section{Client Side Design}
	...
	\section{D20 Terminology}
		...
		\subsubsection{Buffs \& Debuffs}
			...
			These 'buffs' will have a very large impact on how the Critical Encounter's A.I. makes its' decisions on what actions to take each turn, weighing which action would be better for the character.
