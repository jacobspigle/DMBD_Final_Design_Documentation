...
\addcontentsline{toc}{chapter}{User Interface}
	...
	\begin{figure}[!h]
		\centering
		\centerline{\includegraphics[scale=.35]{NavBar}}
		\caption{NavBar}
		\label{fig: NavBar}
	\end{figure}
